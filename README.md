...
- Mobile/partner proof: open `partner-demo.html`, click `Open external link`, and show the `BLOCK_AND_SHOW_INTERSTITIAL` action that a bank or e-wallet app would use.
